...
class UserRegistrationAPIView(generics.CreateAPIView):
    ...
    serializer_class = doc_serializer.UserRegistrationSerializer
...
class UserLoginAPIView(views.APIView):
    ...
    """
    permission_classes = (permissions.AllowAny, )
    serializer_class = doc_serializer.UserLoginSerializer
...
class PasswordResetAPIView(views.APIView):
    ...
    permission_classes = (permissions.AllowAny, )
    serializer_class = doc_serializer.PasswordResetSerializer
...
class PasswordResetConfirmView(views.APIView):
    ...
    permission_classes = (permissions.AllowAny, )
    serializer_class = doc_serializer.PasswordResetConfirmSerializer
...
class UserProfileAPIView(generics.RetrieveAPIView):
    ...
    serializer_class = doc_serializer.UserProfileSerializer
