...
from accounts.helper import models as helper_models
...
class UserProfile(helper_models.TimeStampedModel, Verification):
    """
    ...
    gender = models.CharField(default="M",max_length=6,choices=_GENDER)
    # added extra fields to the UserProfile class
    ...
    def send_password_reset_email(self, site):
        ...
        context = {
            ...
            'site': site,
            'site_name': getattr(settings, 'SITE_NAME', None),
            'uid': helper_utils.base36encode(self.user.pk),
            'user': self.user,
